...
namespace Voxell.MotionGFX
{
    ...
    public static class Interpolation
    {
        ...
        [BurstCompile]
        [AOT.MonoPInvokeCallback(typeof(InterpolationDelegate))]
        public static float EaseInSine(float t) => 1 - cos((t * PI) * 0.5f);

        [BurstCompile]
        [AOT.MonoPInvokeCallback(typeof(InterpolationDelegate))]
        public static float EaseOutSine(float t) => sin((t * PI) * 0.5f);

        [BurstCompile]
        [AOT.MonoPInvokeCallback(typeof(InterpolationDelegate))]
        public static float EaseInOutSine(float t) => -(cos(PI * t) - 1) * 0.5f;
        ...
        [BurstCompile]
        [AOT.MonoPInvokeCallback(typeof(InterpolationDelegate))]
        public static float EaseInExpo(float t) => pow(2.0f, 10.0f * t - 10.0f);

        [BurstCompile]
        [AOT.MonoPInvokeCallback(typeof(InterpolationDelegate))]
        public static float EaseOutExpo(float t) => 1.0f - pow(2.0f, -10.0f * t);

        [BurstCompile]
        [AOT.MonoPInvokeCallback(typeof(InterpolationDelegate))]
        public static float EaseInOutExpo(float t)
            => t < 0.5f ? pow(2.0f, 20.0f * t - 10.0f) * 0.5f : (2.0f - pow(2.0f, -20.0f * t + 10.0f)) * 0.5f;
        ...
        [BurstCompile]
        [AOT.MonoPInvokeCallback(typeof(InterpolationDelegate))]
        public static float EaseInCirc(float t) => 1.0f - sqrt(1.0f - t * t);
